...
Clean and responsive documentation site with sidebar navigation, smooth scrolling, and well-structured content sections.  
[Live Demo](https://documentation-website-of-mine.netlify.app/){:target="_blank"}  
`/documentation-website/`
